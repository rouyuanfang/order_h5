<template>
  <div>
    ...
    <center class="price">¥{{ detail.payAmount }}</center>
    ...
    <div class="btn flex-around">
      <div @click="jumpTo('/home')" class="left">返回首页</div>
...
<script>
import { detailOrder } from "@/service";
export default {
  data() {
    return {
      routeId: 0,
  ...
  methods: {
    ...
    toDetail() {
      this.$router.push({ name: "order-detail", query: { id: this.routeId } });
    },
  },
};
</script>
